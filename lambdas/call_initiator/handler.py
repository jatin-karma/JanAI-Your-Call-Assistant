...
RATE_LIMIT_TABLE = os.environ.get("DYNAMODB_CALLS_TABLE", "janai-calls")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if "unverified" in error_msg.lower():
            return cors_response(400, {
                "error": "This number is not verified on our trial account. Please call us directly at +1 831 298 8145."
            })
            ...
            return cors_response(500, {
                "error": "Failed to initiate call. Please try again or call us directly at +1 831 298 8145."
            })
