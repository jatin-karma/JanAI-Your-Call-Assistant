# JanAI – Amazon Connect Lambda handler
...
def _init_call(contact_id, customer_number):
    ...
    return {
        "status":        "ok",
        "welcome_hi":    "JanAI में आपका स्वागत है। हिंदी के लिए एक दबाएं।",
        "welcome_en":    "Welcome to JanAI. For English, press 2.",
        "welcome_full":  "JanAI में आपका स्वागत है। हिंदी के लिए एक दबाएं। Welcome to JanAI. For English, press 2.",
    }
