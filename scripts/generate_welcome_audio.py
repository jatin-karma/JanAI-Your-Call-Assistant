# JanAI - Generate & Upload Welcome Audio
...
CLIPS = {
    "welcome_intro": (
        "नमस्कार! JanAI में आपका स्वागत है। "
        "मैं JanAI हूँ — सरकारी योजनाएँ हों, खेती का सवाल हो, या कुछ भी जानना हो, बस बोलिए!",
...
def main():
    print("=" * 55)
    print("JanAI — Welcome Audio Generator")
    print("=" * 55)
