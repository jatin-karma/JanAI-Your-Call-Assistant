    ...
    <form onSubmit={handleSubmit} className={compact ? 'space-y-3' : 'space-y-5'}>
      ...
      <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl">
        <p className="text-xs text-amber-700 leading-relaxed">
          <strong>Why a US number?</strong> JanAI is in the trial phase for JanAI.
          We are provisioning an Indian toll-free number — until it is active, calls are placed from our US Twilio
          number (+1 831 298 8145). <strong>The call is completely free on our end.</strong> Standard carrier rates
...
const LS_KEY          = 'janai_voice_usage'
...
function VoiceChat() {
  ...
  const voices = [
    { code: 'arya',   label: 'Arya',   icon: '👩', hint: 'Female · General' },
    { code: 'vidya',  label: 'Vidya',  icon: '👩', hint: 'Female · Health' },
    { code: 'hitesh', label: 'Hitesh', icon: '👨', hint: 'Male · General' },
  ]
          ...
          <div className="text-center mb-4 min-h-[80px] flex flex-col items-center justify-center">
            {callStatus === 'idle' && (
              <>
                ...
                <p className="text-gray-400 text-xs mt-1">JanAI · AI Voice Assistant</p>
              </>
            )}
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 md:px-12 py-10">
          ...
          <p className="text-lg text-content-secondary">
            Talk to JanAI — speak directly from your browser or get a callback on your phone
          </p>
        </div>
      </div>
