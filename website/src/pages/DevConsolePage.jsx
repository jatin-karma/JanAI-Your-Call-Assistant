...
const STATES = {
  ...
  thinking:   { ring: 'ring-blue-400',   pulse: true,  label: 'JanAI is thinking…',  emoji: '🤔', color: 'text-blue-400'   },
  responding: { ring: 'ring-violet-500', pulse: true,  label: 'JanAI is speaking…',  emoji: '🔊', color: 'text-violet-400' },
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col select-none">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-semibold leading-tight">JanAI Dev Console</p>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-2 max-w-lg w-full mx-auto">
        {messages.length === 0 && !interimText && (
          <div className="text-center py-8 text-gray-700 text-sm">
            {isOnCall ? 'Speak naturally — JanAI will reply automatically' : 'Press the green call button, then speak'}
          </div>
        )}
