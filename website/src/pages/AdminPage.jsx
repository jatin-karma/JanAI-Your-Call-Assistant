 ...
 *
 * Protected by admin JWT (stored in localStorage as "janai_admin_token").
...
const TOKEN_KEY = 'janai_admin_token'
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">JanAI RAG Admin Portal</p>
        </div>
        {error && (
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-20">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">{entries.length} entries in janai-knowledge</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
