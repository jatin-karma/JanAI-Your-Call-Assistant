...
} from '../components/icons/JanAIIcons'
...
const stats = [
  { value: '50+',   label: 'Verified Schemes',     icon: ShieldStarIcon      },
  { value: '24/7',  label: 'Action & Support',        icon: ClockRoundIcon      },
  { value: '8',     label: 'Languages Supported',     icon: MultiLanguageIcon   },
  { value: '440M+', label: 'Indians We Aim to Serve', icon: IndiaPeopleIcon     },
]
  ...
  return (
    <>
          ...
          <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-24">
            <div className="w-full md:w-[52%] lg:w-[46%]">
              ...
              >
                ...
                <br />
                JanAI changes that — one voice call at a time.
              </p>
      ...
      <section id="how-it-works" className="section bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-accent-500 uppercase tracking-wider mb-2">5 Specialized Agents</p>
            <h2 className="section-title text-center">How It Works</h2>
            <p className="section-subtitle mx-auto mt-2">Q&A and action execution (check status, file complaints, book visits). No app downloads.</p>
          </div>
      ...
      <section id="schemes" className="section bg-surface-secondary">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold text-accent-500 uppercase tracking-wider mb-2">Knowledge & Action Base</p>
            <h2 className="section-title text-center">What Can You Ask JanAI?</h2>
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <div className="flex flex-col leading-none">
                  <span className="font-bold text-lg text-content-primary">JanAI</span>
                  <span className="text-[10px] text-content-tertiary font-medium tracking-wider uppercase">Voice AI for India</span>
                </div>
              </div>
              <p className="text-sm text-content-secondary leading-relaxed">
                Built by Team Kaizen for JanAI.
                JanAI is a Voice-First AI helpline built to serve rural and underserved India — accessible from any basic phone, in any language.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/try" className="block text-sm text-content-secondary hover:text-accent-500 transition-colors">Try JanAI</Link>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-sm text-content-primary mb-3">Team</h4>
              <p className="text-sm text-content-secondary leading-relaxed mb-2">
                <strong>Team Kaizen</strong>
              </p>
              <p className="text-xs text-content-tertiary mb-1">Team Lead: Jatin Karma</p>
              <p className="text-xs text-content-tertiary">Members: Divya Verma, Deepesh Patel, Devansh Burman</p>
            </div>
          </div>
          <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-content-tertiary">© 2026 JanAI — Team Kaizen. All rights reserved.</p>
